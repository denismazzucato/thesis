...
This chapter presents \timesec\sidenotemark[\ref{sas24-eval:timesecurl}], in about 3000 lines of Python code.
...
The first row \nodepnoopt{} of \reftab{bignum-abl} reports the analysis findings without the various analysis stages of \refsec{implementation}, while the second row \depopt{} shows the finding of the full \timesec{} analysis.
