...
\index{Maximal Trace Semantics!Global Loop Counter}
...
\begin{align*}
  ...
  \\
  &\countertracesemanticsnoparam \semanticsof{\passertstmt}\defsetoftraces \DefeQ
...
\index{$k$-Bounded Impact Property!Global Loop Counter}
...
\end{align*}
\end{definition}
\index{$\counterrangename$ Impact Quantifier@Impact Quantifier!$\counterrangename$ with Global Loop Counter}
...
\index{Property!Validation!Global Loop Counter}
...
\index{Impact Quantifier!Abstract Implementation!Abstract \counterrange{} with Global Loop Counter}
...
\index{Sound Implementation!Abstract \counterrangename}
...
\index{Soundness!Abstract \counterrangename}
