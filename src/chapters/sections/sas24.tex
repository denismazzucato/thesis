...
Similarly, \sidetextcite{Tsitovich2011} adopts loop summarization to address termination; \sidetextcite{Courant2017} further refines \textsc{FuncTion}'s scalability and precision through fine-tuning and new heuristics for the widening.
...
\sidetextcite{Chatterjee2021} proposed a simple but effective approach by synthesizing invariants through syntactic program reversal, handling programs with non-determinism and integer values.
