...
\begin{example}
  \denis{Add example showing that with seed the two are also equivalent.}
\end{example}
...
\begin{example}
  ...
  A modified copy of the map on top of the stack, \cf, $\usagemap_0$, is pushed back to the stack:
  \denis{\dots}
\end{example}
...
In the next chapter, we will define a quantitative counterpart of input data usage, able to measure the impact of variations in the input data on the outcome of a program. Notably, we will exploit the output abstraction to obtain numerical values from the output states.
