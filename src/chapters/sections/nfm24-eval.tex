...
\emph{Ce chapitre est basé sur la section d'évaluation du travail publié au Symposium sur les Méthodes Formelles de la NASA (NFM) 2024 \cite[Section 5]{Mazzucato2024b}. Dans les prochains chapitres, nous appliquerons notre cadre quantitatif dans le contexte des réseaux neuronaux.}
