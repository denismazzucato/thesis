...
In the original version of \libra (originally presented in \sidecite[*-16]{Urban2020}, without our quantitative extension), feasible partitions are first grouped by activation pattern, \ie, activation patterns that fix more \relu s are merged with those that fix fewer \relu s.
