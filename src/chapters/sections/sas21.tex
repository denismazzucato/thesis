...
Then, the analysis proceeds backwards, independently for each abstract activation pattern $\defabstractactivationpattern$ and input partition $\definputpartition$ in $\feasiblepartitions$ (\cf{} \refline{independent}).
