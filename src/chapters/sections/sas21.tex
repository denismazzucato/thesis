...
\index{Forward Analysis!Abstract}
...
\index{Backward Analysis!Abstract}
...
\index{Abstract Domains!Neural Networks}
...
\index{\changesname Impact Quantifier@Impact Quantifier!\changesname}
...
\index{Property!Validation!\changesname}
...
\index{\qlibraname Impact Quantifier@Impact Quantifier!\qlibraname}
...
\siderefbox{def}{output-abstraction-semantics}
\index{Property!Validation!\qlibraname}
...
\index{Impact Quantifier!Abstract Implementation!Abstract \abstractchangesname}
...
\index{Sound Implementation!Abstract \abstractchangesname}
...
\index{Soundness!Abstract \abstractchangesname}
...
\index{Impact Quantifier!Abstract Implementation!Abstract \abstractqlibraname}
...
\index{Sound Implementation!Abstract \abstractqlibraname}
\begin{lemma}[$\abstractqlibra$ is a Sound Implementation of $\qlibra$]\lablemma{abstractqlibra-is-sound}
  Let $\definputvariables\in\setof\inputvariables$ be the set of input variables of interest, $\abstractdomain$ the abstract domain, $\backwardsemanticsnoparam$ the family of semantics, and $\buckets\in\vectorbuckets$ the starting output buckets.
  Whenever the following conditions hold:
  \begin{enumerate}[label=(\roman*)]
...
\index{Soundness!Abstract \abstractqlibraname}
...
\index{Soundness!Parallel Implementation \parallelqlibraname}
\begin{theorem}
