...
In this chapter, we introduce the context of neural network analysis, we define formally the concept of feed-forward deep neural networks for classification purposes.
...
\emph{Dans ce chapitre, nous introduisons le contexte de l'analyse des réseaux de neurones et nous définissons formellement le concept des réseaux de neurones profonds feed-forward à des fins de classification.
...
The networks considered in this thesis are acyclic, meaning that the abstract iterator reaches the fixpoint after a finite number of iterations, without the need of traverse the same node multiple times.
