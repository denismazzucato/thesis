...
For instance, we could use the backward semantics of \refdef{?}\sidenote{\denis{This definition will be defined in \refch{abstract-interpretation}, and referenced on the side here.}} to compute $\backwardsemanticsnoparam(\bucket)$.
