...
\begin{marginfigure}
  \begin{tikzpicture}
    ...
    \node (T) at (.7,0) {${\langle\true\rangle}$};
    \node (F) at (2.3,0) {${\langle\false\rangle}$};
    ...
    \draw[decorate,decoration={brace,amplitude=8pt,mirror,raise=4pt},yshift=0pt,xshift=-0.1pt] (-0.3,2.2) -- (-0.3,-0.2) node [black,midway,xshift=-0.7cm] {$\defsetoftraces$};
\end{tikzpicture}
\end{marginfigure}
