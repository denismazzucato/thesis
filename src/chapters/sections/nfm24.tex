...
mix2(x, y):
 ...
 \end{lstlisting}
  ...
  \begin{align*}
    ...
    \left\{
      \begin{array}{l}
        \tracetuple{\locinit}{\langle \true, \true\rangle}\tracearrow\tracetuple{\loc{8}}{\langle \true\rangle}, \\
        \tracetuple{\locinit}{\langle \true, \false\rangle}\tracearrow\tracetuple{\loc{8}}{\langle \false\rangle}, \\
        \tracetuple{\locinit}{\langle \false, \true\rangle}\tracearrow\tracetuple{\loc{8}}{\langle \true\rangle}, \\
        \tracetuple{\locinit}{\langle \false, \true\rangle}\tracearrow\tracetuple{\loc{8}}{\langle \false\rangle}, \\
        \tracetuple{\locinit}{\langle \false, \false\rangle}\tracearrow\tracetuple{\loc{8}}{\langle \false\rangle}
      \end{array}
      \right\}
  \end{align*}
  \begin{marginfigure}
...
The next result shows that the abstract impact $\abstractoutcomes$ is a sound over-approximation of the concrete impact $\outcomes$ \wrt{} the $\le$ operator.
...
The next result shows that the abstract impact $\abstractrange$ is a sound over-approximation of the concrete impact $\range$, \cf{} \refdef*{range}[*-16.2], \wrt{} the $\le$ operator.
...
The next result shows that the abstract impact $\abstractqused$ is a sound over-approximation of the concrete impact $\qused$, \cf{} \refdef*{qused}[*-9] \wrt{} the $\ge$ operator.
