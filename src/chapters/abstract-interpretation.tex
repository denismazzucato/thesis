...
\begin{example}[Forward Reachability State Semantics]
  \denis{Example showing the reachable state semantics as an abstraction of the maximal trace semantics.}
\end{example}
