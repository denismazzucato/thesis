...
\begin{theorem}[Maximal Trace Semantics]\labthm{maximal-trace-semantics}
  ...
  \begin{align*}
    \tracesemanticsnoparam = \lfp^{\tracesubseteq} \lambda \defsetoftraces.\spacer \finalstates \setjoin (\mergesequences{\transitionrelation}{\defsetoftraces})
  \end{align*}
\end{theorem}
\begin{proof}
  See \textcite{Cousot2002}.
\end{proof}
