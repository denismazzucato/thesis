...
As we will see in \refch{quantitative-input-data-usage}, the operators required for the abstract domain may vary depending on the analysis we are performing. For instance, we may require an operator to remove the information about a variable.
