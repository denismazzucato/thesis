...
\begin{tikzpicture}[scale=0.65]
  ...
  \draw[seabornYellow, rounded corners, thick, dashed, rotate=32.4]
      (-0.3,-0.3) rectangle (6.5,0.4);
  \node[seabornYellow, fill=white] at (1.9, 2.5) {Fixpoints};
  \draw[seabornRed, rounded corners, thick, dashed, rotate=32.4]
      (1.8,-0.9) rectangle (5, -0.35);
  \node[seabornRed, fill=white] at (4, 0.5) {Prefixpoints};
  \draw[seabornGreen, rounded corners, thick, dashed]
      (5,5.8) -- (5,4) -- (7,5);
  \node[seabornGreen, fill=white] at (3.6, 4.7) {Postfixpoints};
  % \node[seabornYellow, fill=white] at (1, 0) {Lub};
\end{tikzpicture}
