...
which provide a sound and computable over-approximation of the concrete semantics.
  We introduce the concept of abstract domains with a simple example of the integer interval abstract domain \sidecite{Cousot1977}, called \intervalname, \wrt{} the concrete domain of integers, \ie, $\values = \Z$.
...
\denis{TODO: Add the most common numerical abstract domains.}

\begin{description}
  \item[Signs]
  \item[Powerset]
  \item[Excluded Powerset]
  \item[Intervals]
  \item[Disjunctive Intervals Domain]
  \item[Congruences]
\end{description}
...
\denis{General Relational Domain}

\denis{Reduced product}
