...
\begin{description}
  ...
  \marginnote{
    \begin{align*}
      &\forwardsemanticsnoparam \semanticsof{\plassignstmt}\defabstractvalue \DefeQ \abstractdomainassign(\defabstractvalue, \defvariable, \defaexp)
    \end{align*}
  }
  ...
  \marginnote{
    \begin{align*}
      ...
      &\quad \abstractdomainfilter(\defabstractvalue, \defbexp) \abstractdomainjoin \abstractdomainfilter(\defabstractvalue, \neg\defbexp)
    \end{align*}
  }
