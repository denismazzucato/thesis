...
Based on this, formal methods are classified into three categories \sidecite{Cousot2010} (\cf{} \reffig{formal-methods-trade-offs}): \emph{theorem provering}, \emph{model checking}/\emph{symbolic execution}, and \emph{static analysis}.
...
Theorem provers \sidecite{Nawaz2019} produce proofs of correctness using interactive tools, also called proof assistants, such as \textsc{Coq} \sidecite{Bertot2004}, \textsc{HOL Light} \sidecite{Harrison2009}, \textsc{Lean} \sidecite{Moura2021}, \textsc{Isabelle} \sidecite{Wenzel2008}, and \textsc{Agda} \sidecite{Bove2009,Wadler2022}; or automatic ones \sidecite{Sutcliffe2001}.
...
In this category also fall proof-oriented programming languages, such as \textsc{Dafny} \sidecite{Leino2010},  \textsc{F*} \sidecite{Swamy2016}, and \textsc{Why3} \sidecite{Filli_atre2013}.
...
For instance, the \textsc{Astrée} static analyzer \sidecite{Blanchet2003} is routinely used to ensure the absence of runtime errors in embedded synchronous C programs for the Airbus A340 and A380.
