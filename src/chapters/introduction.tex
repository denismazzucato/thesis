...
Based on this, formal methods are classified into three categories \sidecite{Cousot2010} (\cf{} \reffig{formal-methods-trade-offs}): \emph{theorem provering}, \emph{model checking}, and \emph{static analysis}. \denis{Symbolic Execution as well.}
