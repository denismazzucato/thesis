...
Abstract Interpretation \sidecite{Cousot1977} is a general theory for approximating program semantics, developed by Patrick and Radhia Cousot in the late 1970s (see \sidecite{Cousot2024a} for an historical view).
...
At the end of the thesis, in \arefpart{conclusion}, we conclude the thesis with a summary and perspectives on future work.
