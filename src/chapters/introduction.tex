...
\marginnote[*-16]{\refch{quantitative-input-data-usage} and \refch{showcase} are based on the work published at NASA Formal Methods
Symposium (NFM) 2024 \cite{Mazzucato2024b}.}
\marginnote[*-13.5]{\formatmargincitation{Mazzucato2024b}}
...
\marginnote[*-11]{\refch{quantitative-fairness} and \refch{evaluation-on-neural-networks} are based on the work published at the 28th Static Analysis Symposium (SAS) 2021 \cite{Mazzucato2021}.}
\marginnote[*-8.5]{\formatmargincitation{Mazzucato2021}}
