...
Current formal methods can be classified into three categories\sidecite{Cousot2010}: \emph{theorem provers}, \emph{model checking}, and \emph{static analysis} (\reffig{formal-methods-trade-offs}).
...
\marginnote{\refch{quantitative-input-data-usage} is based on work published at NASA Formal Methods
...
\marginnote{\refch{quantitative-fairness} is based on work published at the 28th Static Analysis Symposium (SAS) 2021 \cite{Mazzucato2021}.}
\marginnote{\formatmargincitation{Mazzucato2021}}


\paragraph{Experimental Evaluation of Extensional Properties}
\refch{experimental-extensional} demonstrates the quantitative framework's potential applications by evaluating our static analysis tool, \impatto, against six use cases, and presents our approach's evaluation on neural networks.
...
In \refch{showcase-of-outcomes-and-ranges}, we present \timesec, a tool implementing our quantitative timing analysis.
