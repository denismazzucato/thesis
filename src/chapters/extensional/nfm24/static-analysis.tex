...
\[\backwardconcretization(\backwardsemantics)\bucket \DefeQ \setdef{\inputoutputtuple{\defstate}}{\retrieveinput{\defstate}\in\abstractdomainconcretization(\backwardsemantics\bucket)\land\retrieveoutput{\defstate}\in\abstractdomainconcretization(\bucket)}\]
...
\begin{theorem}[Soundness] \label{th:soundness}
  ...
  \begin{enumerate}[label=(\roman*)]
    ...
    \item $\buckets$ covers the subset of potential outcomes $\filter$, \cf{} \refdef{covering}, and
...
\begin{proof}
  ...
  By definitions of $\abstractoutcomes$, \cf{} \refeq{abstract-outcomes}, and $\outcomes$, \cf{} \refeq{outcomes}, we need to show that:
  \begin{gather}
