...
We implemented a proof-of-concept tool\sidenote{\url{https://github.com/denismazzucato/impatto}} in Python 3 that employs the \interproc\sidenote{\url{https://github.com/jogiet/interproc}} abstract interpreter to perform the backward analysis.
...
the technical critique by \sidecitet{Herndon2014}, and an online discussion\sidenote{\url{https://economics.stackexchange.com/q/18553}}.
The~\refprog{rr}
...
The second use case we present is drawn from Sam Altman's recent OpenAI keynote in September 2023\footnote{\url{https://www.youtube.com/live/U9mJuUkhUzk?si=HOzuH3-gr_kTdhCt&t=2330}}, where he presented the GPT-4 Turbo.
...
%
% \begin{table}[t]
%   \caption{Results of the quantitative analysis for \refprog{refprog-division} and \refprog{refprog-analysis}.}
% \begin{subtable}{.83\textwidth}
%   \centering
%   \begin{tabular}{c | ccc}
%     \textsc{Impact} & \rotatebox{21}{\texttt{airbnb\_total\_cost\_eur}} & \rotatebox{21}{\texttt{flight\_cost\_usd}} & \rotatebox{21}{\texttt{number\_of\_friends}} \\
%     \toprule
%     \outcomesname{} & 10 & 17 & 9 \\
%     \rangename{} & 1099 & 1709 & 999 \\
%     \bottomrule
%   \end{tabular}
%   \caption{\refprog{share-division} computing the share division among friends.}
%   \labtab{gpt-4-turbo}
% \end{subtable}%

% \begin{subtable}{.17\textwidth}
%   %\vspace{%-5.1pt}
%   \centering
%   \begin{tabular}{c | c@{\hskip 5pt}c}
%     ~ & \rotatebox{0}{\texttt{x}} & \rotatebox{0}{\texttt{y}} \\
%     \toprule
%     ~ & 50 & 10 \\
%     ~ & 499 & 99 \\
%     \bottomrule
%   \end{tabular}
%   \caption{\refprog{timing-analysis}.}
...
\labsec{termination-analysis}

\refprog{refprog-analysis} is adapted from the termination category of the software verification competition \textsc{sv-comp}\footnote{\url{https://sv-comp.sosy-lab.org/}}.
...
We apply our quantitative analysis to~\refprog{example} for the landing alarm system extended with the  continuous input space for the aircraft angle of approach, where $(-4 \le \texttt{angle} \le 4) \land (1 \le \texttt{speed} \le 3)$, see \reffig{extended}.
